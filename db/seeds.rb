...
[{ :name => 'AFGHANISTAN', :printable_name => 'Afghanistan', :iso => 'AF', :iso3 => 'AFG', :numcode => '004', :lat => 33, :lng => 65 },
...
{ :name => 'ZIMBABWE', :printable_name => 'Zimbabwe', :iso => 'ZW', :iso3 => 'ZWE', :numcode => '716', :lat => -20, :lng => 30 }].each do |c|
