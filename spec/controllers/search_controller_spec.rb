...
describe SearchController do
  ...
  before(:all) do
    @user_1 = FactoryGirl.create(:user, :username => "johnc", :first_name => "John", :last_name => "Coltrane")
    @user_2 = FactoryGirl.create(:user, :username => "milesd", :first_name => "Miles", :last_name => "Davis")
    @user_3 = FactoryGirl.create(:user, :username => "louisa", :first_name => "Johnie", :last_name => "Armstrong")
    @user_4 = FactoryGirl.create(:user, :username => "charilep", :first_name => "John", :last_name => "Parker")
  ...
  describe "GET 'index'" do
    ...
    describe do "search by username"
      ...
      it "should return correct record if query params is part of the word" do
        get 'index', :q => 'aril'
        assigns[:results].first.username.should == "charilep"
      end
